...
export default function CreateAuction(props: Props) {
    ...
    const { config } = usePrepareContractWrite({
        ...
        args: [community.artName, community.minPrice, community.setPrice, community.priceDecrement, community.timing],
    })
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mb-4">
                        ...
                        <input
                            ...
                            id="priceDecrement"
                            name="priceDecrement"
                            value={community.priceDecrement}
                            onChange={handleChange}
                            className="w-full px-3 py-2 border rounded-lg focus:outline-none focus:border-blue-500 text-black"
                        />
                    </div>
